//       { adminpage, getVoiture,banUser,debanUser,  } = require ("./AdminController"),
...
const { accountpage, editProfile, addVoiture, delVoiture, editVoiture, delCom} = require("./AccountController-api");
